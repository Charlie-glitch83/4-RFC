...
assert deriv['classification']=='PARENT_DERIVED_MICROSCOPIC_QUADRATIC_LAW'
...
micro={
 ...
 'parent':deriv['parent'],
 'quadratic_generator':{
   'operator_identity':deriv['derivation']['operator_identity'],
   'matrix':deriv['derivation']['matrix'],
   'quadratic_form':deriv['derivation']['quadratic_form'],
   'selection_rule':deriv['derivation']['selection_rule'],
   'units':deriv['microscopic_interpretation']['gap_units']
 },
 'symmetry':{
   'name':'B_PATH_REFLECTION','generator_matrix':deriv['derivation']['reflection_generator'],
   'reflection_invariant':deriv['invariants']['reflection_invariant']
 },
 'spectral_constitution':{
   'basis':deriv['microscopic_interpretation']['basis'],
   'eigenvalues':deriv['microscopic_interpretation']['eigenvalues'],
   'eigenvectors':deriv['microscopic_interpretation']['eigenvectors'],
   'minimum_eigenvalue':deriv['invariants']['minimum_eigenvalue'],
   'zero_mode_residual':deriv['invariants']['zero_mode_residual'],
   'positive_semidefinite':deriv['invariants']['positive_semidefinite'],
   'named_standard_model_correspondence':deriv['microscopic_interpretation']['named_standard_model_correspondence']
 },
 'charge_and_conservation':{
   'ownership':deriv['microscopic_interpretation']['charge_ownership'],
   'mode_total_ledger_components':deriv['microscopic_interpretation']['mode_total_ledger_components'],
   'total_parent_carrier':ind['total_carrier_charge']
 },
 'interaction_scope':{
   'executed':'parent-derived quadratic relational coupling',
   'nonlinear_interactions':deriv['microscopic_interpretation']['nonlinear_interactions'],
   'physical_mass_scale':'NOT_DERIVED_AT_C120',
   'measured_couplings_imported':False
 },
 'prethermal_state':deriv['prethermal_state'],
 'clock_and_geometry':{'event_order_origin':0,'continuous_time_scale':None,'metric_geometry_assumed':False},
